...
#[derive(Debug, Eq, PartialEq, Hash, Clone, Copy, FromBytes, AsBytes)]
#[repr(C)]
...
impl DiskManager {
    ...
    pub fn read_page_data(&mut self, page_id: PageId, data: &mut [u8]) -> io::Result<()> {
        let offset: u64 = PAGE_SIZE as u64 * page_id.to_u64();
...
mod tests {
    ...
    fn page_id_valid() {
        ...
        assert_eq!(page_id.valid(), Some(PageId(10)));
